  ...
  getTopPanelConfig(): any {
    return {
      ...
      filtersConfig: [
        ...
        {
          type: 'checkbox',
          id: 'has_suggested_transfer',
          label: 'Suppliers with Suggested Transfers',
          divClass: 'three-col d-flex flex-column-reverse',
        },
        {
          type: 'checkbox',
          id: 'has_negative_balance',
          label: 'Suppliers with Negative BA Balance',
        },
        { type: 'checkbox', id: 'has_overdraft_fees', label: 'Suppliers with Overdraft Fees' },
        {
          type: 'checkbox',
          id: 'suppliers_reaching_credit_limit',
          label: 'Suppliers reaching Credit Limit',
        },
        {
          type: 'checkbox',
          id: 'suppliers_exceeding_credit_limit',
          label: 'Suppliers exceeding Credit Limit',
        },
      ],
    };
  }
